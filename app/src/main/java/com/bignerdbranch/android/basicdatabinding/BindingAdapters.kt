...
import com.bignerdbranch.android.basicdatabinding.Popularity
import com.bignerdbranch.android.basicdatabinding.R
 ...
 *
 *  NOTE: look at the xml to know how it is presented. Also all attributes that are required must be defined in the xml
 *
 *
 *  NOTE: When one value changes, this android re-invoke this method.
 */
 ...
 * of likes is zero.
 *
 * The First parameter should be the Widget calling the method. e.g [ProgressBar],[TextView]...but using
 * the superclass [View] is better.
 */
